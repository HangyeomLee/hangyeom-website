...
export const experience: ExperienceEntry[] = [
  {
    ...
    bullets: [
      ...
      "Connected Shippo so staff can go from a confirmed order to a printed Canada Post or UPS label without asking me for anything. A single wrong field name in that integration later had us [buying duplicate labels](/blog/the-double-billing-mystery) on every retry.",
